...
def process_query(query: str, image_base64: Optional[str] = None) -> ProcessResponse:
    ...
    from server.services.planning.complexity_router import route_capability
    ...
    from server.services.planning.coordinate_validator import validate_coordinate
...
def relocate_step(
    ...
    if matched_element:
        ...
        if matched_element.center:
            from server.services.planning.coordinate_validator import validate_coordinate as vc
