...
async def stats_top_tasks(
    ...
    from server_v2.database import SessionLocal
    from sqlalchemy import func
    from server_v2.database.models import Transaction
...
async def failures_list(
    ...
    from server_v2.database import SessionLocal
    from server_v2.database.models import Failure
...
async def stats_feedback(admin_key: str = Depends(verify_admin_key)):
    from server_v2.database import SessionLocal
    from sqlalchemy import func
    from server_v2.database.models import Feedback
