"""Luxury v2 demo painting — starfield, frosted/kraft bg, shell modes (Demo only)."""
...
def paint_luxury_frame(
    ...
    *,
    ...
    star_intensity: int = 60,
    radius: float = 10.0,
    compact: bool = False,
) -> None:
    """Full luxury v2 shell stack: background → stars → shell overlay."""
